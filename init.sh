...
cd
cd /etc/yum.repos.d/
sudo wget -O /etc/yum.repos.d/shells:fish:release:3.repo --no-check-certificate https://download.opensuse.org/repositories/shells:fish:release:3/CentOS_7/shells:fish:release:3.repo
